...
FLUTTER_PLUGIN_EXPORT GType flutter_volume_controller_plugin_get_type();

FLUTTER_PLUGIN_EXPORT void flutter_volume_controller_plugin_register_with_registrar(
